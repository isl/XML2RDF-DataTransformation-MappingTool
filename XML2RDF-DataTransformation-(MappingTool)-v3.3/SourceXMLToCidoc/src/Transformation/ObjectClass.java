...
public class ObjectClass {
    ...
    public ObjectClass(String entity, String uriFunctionName, ArrayList uriFunctionArguments, String attribute, String src_range) {
        this.entity = entity;
